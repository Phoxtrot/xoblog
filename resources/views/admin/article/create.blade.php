            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="POST"action="{{route('article.store')}}" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    ...
                    <select class="form-control" name='category_id' value="{{ old('category_id') }}" id="exampleFormControlSelect2">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="body" id="editor" style='height:100%' rows="10">{{ old('body') }}</textarea>
                    @error('body')
                    	<p class="error" style="color: #ed3c0d;text-align: left;">
                   		{{ $message }}
                    	</p>
